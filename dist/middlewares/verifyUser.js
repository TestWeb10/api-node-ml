...
var verifyUser = exports.verifyUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$decodedJwtToken, userId, mlToken, sicofiToken, dbConnection, usersModel, user;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          usersModel = dbConnection.model(_config["default"].COLLECTION_NAME, _Users["default"].schema);
          _context.next = 7;
        ...
        case 21:
          return _context.abrupt("return", res.status(403).json({
            error: "",
            message: "No se proporciono el token decodificado de la aplicacion."
          }));
        case 22:
        case "end":

  ...
  _createClass(Tokens, null, [{
    ...
    value: function () {
      var _getMLToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(client_id, client_secret, grant_type) {
        var expiredToken, params, URI, response, data;
    ...
    key: "getSicofiToken",
    value: function () {
      var _getSicofiToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(username_sic, password_sic, userType) {
        var expiredToken, cad, base64data, URI, response, data;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              expiredToken = "eyJhbGciOiJodHRwOi8vd3d3LnczLm9yZy8yMDAxLzA0L3htbGRzaWctbW9yZSNobWFjLXNoYTI1NiIsInR5cCI6IkpXVCJ9.eyJodHRwOi8vc2NoZW1hcy54bWxzb2FwLm9yZy93cy8yMDA1LzA1L2lkZW50aXR5L2NsYWltcy9uYW1lIjoiZGlnaWZhY3Q1MTdAbWFpbC5jb20iLCJleHAiOjE3MDczNTQzODcsImlzcyI6ImRpZ2lmYWN0LmNvbSIsImF1ZCI6ImRpZ2lmYWN0LmNvbSJ9.mt4lUtCHqfisXrwx1RuTbH_0TUbavad6DRYCq1BMv4Q";
              if (!(username_sic && password_sic)) {
                _context2.next = 24;
                break;
              }
              cad = username_sic + ":" + password_sic;
              base64data = Buffer.from(cad).toString('base64');
              _context2.prev = 4;
              URI = userType == "demo" ? _config["default"].URI_DEMO_SICOFI + "/auth/token" : _config["default"].URI_PRODUCTION_SICOFI + "/auth/token";
              _context2.next = 8;
              return (0, _crossFetch["default"])(URI, {
                method: 'POST',
                headers: {
            ...
            case 16:
              return _context2.abrupt("return", expiredToken);
            case 17:
              _context2.next = 22;
              break;
            case 19:
      ...
      function getSicofiToken(_x4, _x5, _x6) {
        return _getSicofiToken.apply(this, arguments);
      }
      return getSicofiToken;
    }()
  }]);
  return Tokens;
}();

      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", res.status(400).json({
            error: "",
            message: "CFDI traslado dado de baja :(."
          }));
        case 1:
        case "end":
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", res.status(400).json({
            error: "",
            message: "CFDI ingreso dado de baja :(."
          }));
        case 1:
        case "end":
...
var cfdiTrasladoCP = exports.cfdiTrasladoCP = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, invoiceInformation, DatosCFDI40, ReceptorCFDI40, ConceptosCFDI40, CartaPorte30, _req$decodedJwtToken, userId, mlToken, sicofiToken, jwtToken, _req$userData, user, usersModel, userType, _loop, _ret, it;
    return _regeneratorRuntime().wrap(function _callee3$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body = req.body, invoiceInformation = _req$body.invoiceInformation, DatosCFDI40 = _req$body.DatosCFDI40, ReceptorCFDI40 = _req$body.ReceptorCFDI40, ConceptosCFDI40 = _req$body.ConceptosCFDI40, CartaPorte30 = _req$body.CartaPorte30;
          ...
          _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
            var body, headers, URI, response, band, resJson, _message, invoiceText, messageML, obj, updatedUser, message;
            return _regeneratorRuntime().wrap(function _loop$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                ...
                case 29:
                  ...
                  //     console.log(err);
                  // }
                  messageML = ""; // if (userType == "production") {
                  //     // Cargamos factura en Mercado Libre
                  //     try {
                  //         for (let k = 0; k < 2; k++) {
                  //             if (messageML == "") {
                  //                 let client_id = user.client_id
                  //                 let client_secret = user.client_secret
                  //                 let grant_type = user.grant_type
                  //                 let access_token = mlToken
                  //                 let formData = new FormData()
                  //                 formData.append("fiscal_document", invoiceText)
                  //                 let responseML = await fetch(`${config.URI_ML}/packs/${client_id}/fiscal_documents`, {
                  //                     method: 'POST',
                  //                     headers: {
                  ...
                  //                     body: formData
                  //                 })
                  //                 let responseMLText = await responseML.text()
                  //                 if (responseML.status == 401) {
                  //                     // Token vencido, por tanto obtenemos uno nuevo y lo volvemos a intentar
                  //                     mlToken = await Tokens.getMLToken(client_id, client_secret, grant_type)
                  //                     jwtToken = jwt.sign({
                  //                         userId: userId,
                  //                         mlToken: mlToken,
                  //                         sicofiToken: sicofiToken
                  ...
                  //                     }
                  //                     if (k == 1) {
                  //                         messageML = `\n\nCARGA DE FACTURA TRASLADO MERCADO LIBRE (${responseML.status})\nLa factura no fue posible cargarla en Mercado Libre, ocurrio un problema al renovar el token de Mercado Libre. Se debera cargar la factura manualmente en Mercado Libre.\n${responseMLText}`
                  //                     }
                  //                 } else if (responseML.status == 200) {
                  //                     messageML = `\n\nCARGA DE FACTURA TRASLADO MERCADO LIBRE (${responseML.status})\nLa factura se ha cargado exitosamente en Mercado Libre.\n${responseMLText}`
                  //                 } else {
                  //                     messageML = `\n\nCARGA DE FACTURA TRASLADO MERCADO LIBRE (${responseML.status})\nLa factura no fue posible cargarla en Mercado Libre, ocurrio un problema. Se debera cargar la factura manualmente en Mercado Libre.\n${responseMLText}`
                  //                 }
                  //             }
                  //         }
                  //     } catch (error) {
                  //         messageML = `\n\nCARGA DE FACTURA TRASLADO MERCADO LIBRE (error)\nHubo un problema al cargar la factura en Mercado Libre. Se debera cargar la factura manualmente en Mercado Libre.`
                  //     }
                  // }
                  // Guardamos la informacion correspondiente de la factura en la base de datos
                  _context3.prev = 31;
                  obj = {
                ...
                case 35:
                  ...
                  return _context3.abrupt("return", {
                    v: res.status(200).json({
                      error: "",
                      message: "Los datos se enviaron correctamente a Sicofi. Ademas se ha guardado en la base de datos correctamente." + messageML,
                      jwtToken: jwtToken,
                ...
                case 39:
                  ...
                  return _context3.abrupt("return", {
                    v: res.status(200).json({
                      error: "",
                      message: "Los datos se enviaron correctamente a Sicofi. Con el inconveniente de que no fue posible guardar en la base de datos correctamente." + messageML,
                      jwtToken: jwtToken,
...
var cfdiIngresoCP = exports.cfdiIngresoCP = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body2, invoiceInformation, DatosCFDI40, ReceptorCFDI40, ConceptosCFDI40, CartaPorte30, _req$decodedJwtToken2, userId, mlToken, sicofiToken, jwtToken, _req$userData2, user, usersModel, userType, _loop2, _ret2, it;
    return _regeneratorRuntime().wrap(function _callee4$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _req$body2 = req.body, invoiceInformation = _req$body2.invoiceInformation, DatosCFDI40 = _req$body2.DatosCFDI40, ReceptorCFDI40 = _req$body2.ReceptorCFDI40, ConceptosCFDI40 = _req$body2.ConceptosCFDI40, CartaPorte30 = _req$body2.CartaPorte30;
          if (!(invoiceInformation && DatosCFDI40 && ReceptorCFDI40 && ConceptosCFDI40 && CartaPorte30)) {
            _context6.next = 20;
            break;
          }
          ...
          _loop2 = /*#__PURE__*/_regeneratorRuntime().mark(function _loop2() {
            var body, headers, URI, response, band, resJson, _message2, invoiceText, messageML, obj, updatedUser, message;
            return _regeneratorRuntime().wrap(function _loop2$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                ...
                case 29:
                  ...
                  //                     }
                  //                     if (k == 1) {
                  //                         messageML = `\n\nCARGA DE FACTURA INGRESO MERCADO LIBRE (${responseML.status})\nLa factura no fue posible cargarla en Mercado Libre, ocurrio un problema al renovar el token de Mercado Libre. Se debera cargar la factura manualmente en Mercado Libre.\n${responseMLText}`
                  //                     }
                  //                 } else if (responseML.status == 200) {
                  //                     messageML = `\n\nCARGA DE FACTURA INGRESO MERCADO LIBRE (${responseML.status})\nLa factura se ha cargado exitosamente en Mercado Libre.\n${responseMLText}`
                  //                 } else {
                  ...
                  //         }
                  //     } catch (error) {
                  //         messageML = `\n\nCARGA DE FACTURA INGRESO MERCADO LIBRE (error)\nHubo un problema al cargar la factura en Mercado Libre. Se debera cargar la factura manualmente en Mercado Libre.`
                  //     }
                  // }
                  // Guardamos la informacion correspondiente de la factura en la base de datos
                  _context5.prev = 31;

...
var changePassword = exports.changePassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, username_sic, old_password_sic, new_password_sic, encoded_username_sic, encoded_old_password_sic, encoded_new_password_sic, dbConnection, updatedUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, username_sic = _req$body.username_sic, old_password_sic = _req$body.old_password_sic, new_password_sic = _req$body.new_password_sic;
          if (!(username_sic && old_password_sic && new_password_sic)) {
            _context.next = 22;
            break;
          }
          encoded_username_sic = _Users["default"].encodeUsernameSicofi(username_sic);
          encoded_old_password_sic = _Users["default"].encodeUsernameSicofi(old_password_sic);
          encoded_new_password_sic = _Users["default"].encodeUsernameSicofi(new_password_sic);
          _context.prev = 5;
          dbConnection = (0, _dbConnection.getDbConnection)();
          _context.next = 9;
          return dbConnection.collection(_config["default"].COLLECTION_NAME).findOneAndUpdate({
            username_sic: encoded_username_sic,
            password_sic: encoded_old_password_sic
          }, {
            $set: {
              password_sic: encoded_new_password_sic
            }
          }, {
            _id: 1
          });
        ...
        case 14:
          return _context.abrupt("return", res.status(404).json({
            error: "",
            message: "Los datos no coinciden con ningun registro en la base de datos."
          }));
        case 15:
          _context.next = 20;
          break;

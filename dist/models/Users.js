    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          salts = _context.sent;
          _context.next = 5;
          return _bcrypt["default"].hash(password, salts);
        case 5:
...
usersSchema.methods.encodeUsernameSicofi = function (username_sic) {
  var base64data = Buffer.from(username_sic).toString('base64');
  return base64data;
};
usersSchema.methods.encodePasswordSicofi = function (password_sic) {
  var base64data = Buffer.from(password_sic).toString('base64');
  return base64data;
};
usersSchema.statics.decodeUsernameSicofi = function (username_sic) {
  var decoded_username_sic = Buffer.from(username_sic, 'base64').toString('ascii');
  return decoded_username_sic;
};
usersSchema.statics.decodePasswordSicofi = function (password_sic) {
  var decoded_password_sic = Buffer.from(password_sic, 'base64').toString('ascii');
  return decoded_password_sic;
};
module.exports = (0, _mongoose.model)(_config["default"].COLLECTION_NAME, usersSchema);